...
export class InitialSchema1778081673810 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."task_state_enum" AS ENUM('draft', 'todo', 'inProgress', 'done', 'archived')`);
