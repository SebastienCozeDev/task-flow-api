...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve all users with admin privilege' }),
...
__decorate([
    ...
    (0, common_1.Post)(),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new user with admin privilege' }),
...
__decorate([
    ...
    (0, common_1.Get)('me'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve the current user' }),
...
__decorate([
    ...
    (0, common_1.Patch)('me'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update the current user' }),
    __param(0, (0, common_1.Request)()),
